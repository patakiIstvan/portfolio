...
function Slidebar(props) {
  ...
  return (
    <div className={props.navMenu ? 'isOpen slidebar' : 'isClose slidebar'} onClick={props.toggleNav} >
      <Image alt="close navigation menu" className="menuicon" width={32} height={32} src={'data:image/svg+xml,%3Csvg xmlns="http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg" width="25" height="25" viewBox="0 0 24 24"%3E%3Cpath fill="white" d="m13.41 12l4.3-4.29a1 1 0 1 0-1.42-1.42L12 10.59l-4.29-4.3a1 1 0 0 0-1.42 1.42l4.3 4.29l-4.3 4.29a1 1 0 0 0 0 1.42a1 1 0 0 0 1.42 0l4.29-4.3l4.29 4.3a1 1 0 0 0 1.42 0a1 1 0 0 0 0-1.42Z"%2F%3E%3C%2Fsvg%3E'} />
      {props.navItems}
    </div >
  )
}