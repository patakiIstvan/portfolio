  ...
  return (
    <>
      {version && updateList.length &&
        <div id="PopUpGeneral" className="popup-module popup-wrap warning show" onClick={closeModal}>
          <div className="popup-body bounceInDown" aria-modal="true" role="alertdialog" aria-labelledby="dialog_label"
            ...
            <div id="dialog_label" className="title">New resume available</div>
            <div id="dialog_desc" className="text">
            ...
            <div className="btn-wrap noselect">
              <a href="/assets/pdf/resume_en.pdf" download="Resume István Pataki"><button id="BtnOK" className="btn btn-ok">Download updated resume</button></a>
            </div>
          </div>
        </div>
      }
